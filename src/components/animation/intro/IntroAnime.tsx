        ...
        scrollTrigger: {
          ...
          onEnter: function () {
            gsap.utils.toArray('#bats path').forEach((item, i) => {
              return gsap.to(item as EventTarget, {
                scaleX: 0.5,
                yoyo: true,
                repeat: 11,
                duration: 0.15,
    ...
    if (fsEnter) {
      fsEnter.addEventListener('click', function (e) {
        ...
        if (!fullscreen) {
          ...
          if (fsEnter) fsEnter.innerHTML = 'Exit Fullscreen'
        } else {
          fullscreen = false
          document.exitFullscreen()
          if (fsEnter) fsEnter.innerHTML = 'Go Fullscreen'
        }
      })
    }
  }, [])
          ...
          <g id='hills1'>
            ...
            <g id='info'>
              ...
              <path
                ...
                strokeMiterlimit='10'
                strokeWidth='0.5'
                transform='scale(0.8) translate(90, 80)'
              />
            </g>
            <path
              id='bird'
